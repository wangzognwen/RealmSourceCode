...
package com.wangzhe.realmsourcecode.realm;
 ...
 * lead to {@link OutOfMemoryError} as the native resources cannot be freed.
 * <p>
...
public class Realm extends BaseRealm {
     ...
     * @throws NullPointerException if no default configuration has been defined.
     ...
     * @see #createAllFromJson(Class, JSONArray)
     */
     ...
     * @see #createOrUpdateAllFromJson(Class, InputStream)
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
     ...
     * @throws IllegalArgumentException if the JSON object doesn't have a primary key property but the corresponding
     * {@link RealmObjectSchema} has a {@link io.realm.annotations.PrimaryKey} defined.
     * @see #createOrUpdateObjectFromJson(Class, JSONObject)
     */
     ...
     *
     * @param clazz Type of {@link io.realm.RealmObject} to create or update. It must have a primary key defined.
     * @param json {@link JSONObject} with object data.
     * @return created or updated {@link io.realm.RealmObject}.
     * @throws IllegalArgumentException if trying to update a class without a {@link io.realm.annotations.PrimaryKey}.
     * @throws IllegalArgumentException if the JSON object doesn't have a primary key property but the corresponding
     * {@link RealmObjectSchema} has a {@link io.realm.annotations.PrimaryKey} defined.
     * @throws RealmException if JSON data cannot be mapped.
     * @see #createObjectFromJson(Class, JSONObject)
     */
     ...
     * @see #createObjectFromJson(Class, InputStream)
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
     ...
     * @throws IllegalArgumentException if the object is {@code null} or it belongs to a Realm instance
     ...
     * @throws IllegalArgumentException if the object is {@code null} or doesn't have a Primary key defined
     ...
     * @throws IllegalArgumentException if any of the elements in the input collection is {@code null}.
     */
     ...
     * @throws IllegalArgumentException if RealmObject is {@code null} or doesn't have a Primary key defined.
     * @see #copyToRealm(Iterable)
     */
     ...
     */
    public RealmAsyncTask executeTransactionAsync(final Transaction transaction,
            final Transaction.OnSuccess onSuccess,
            final Transaction.OnError onError) {
        checkIfValid();
